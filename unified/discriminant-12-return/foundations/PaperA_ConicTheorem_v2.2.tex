...
Y^2=-\frac ab x^2,
\]
which factors into two lines in the full algebraic cone section. The cases $a=0$ or $b=0$ are the row/column parabolas below. If $a=b\ne0$, then $x+y=c/a$ is constant.
\end{proof}
