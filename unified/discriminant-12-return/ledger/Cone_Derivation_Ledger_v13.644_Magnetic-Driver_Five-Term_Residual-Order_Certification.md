# Cone Derivation Ledger v13.644 — Magnetic-Driver Five-Term Residual-Order Certification

Date: 2026-09-22

## 0. Collision/relevance check

The live ledger was checked before work and immediately before this write. v13.643 is the latest numbered ledger entry; a parallel chi_-4 script commit landed while this reproducer was being added but has not claimed v13.644 at this check. This gate uses the authoritative magnetic endpoint coefficients in v13.642.
